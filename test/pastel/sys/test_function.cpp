...
TEST_CASE("FirstAndSecond (function)")
{
	...
	PASTEL_CONCEPT_CHECK(First_Function, Function_Concept<dreal>(Pair));
	PASTEL_CONCEPT_REJECT(First_Function, Function_Concept<dreal&>(Pair));
	PASTEL_CONCEPT_CHECK(First_Function, Function_Concept<const dreal&>(Pair));

	PASTEL_CONCEPT_CHECK(Second_Function, Function_Concept<dreal>(Pair));
	PASTEL_CONCEPT_CHECK(Second_Function, Function_Concept<dreal&>(Pair));

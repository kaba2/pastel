...
TEST_CASE("SignedToTwosComplement (twos_complement)")
{
...
TEST_CASE("TwosComplementToSigned (twos_complement)")
{
...
TEST_CASE("Inverse (twos_complement)")
{
...
TEST_CASE("OtherInverse (twos_complement)")
{
...
TEST_CASE("Shifts (twos_complement)")
{

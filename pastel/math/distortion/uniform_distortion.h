...
namespace Pastel
{
	...
	*/
	...
	template <typename Real, int N, EnableIfC<(N == 1)> = 0>
	...
	template <typename Real, int N, EnableIfC<(N == 2)> = 0>
	Vector<Real, N> uniformlySampleAnnulus(
		const Vector<Real, N>& uv,
		const NoDeduction<Real>& minRadius,
		const NoDeduction<Real>& maxRadius);

	template <typename Real, int N, EnableIfC<(N == 3)> = 0>
	Vector<Real, N> uniformlySampleAnnulus(
		const Vector<Real, N>& uv,
		const NoDeduction<Real>& minRadius,
		const NoDeduction<Real>& maxRadius);
	...
	*/
	...
	template <typename Real, int N, EnableIfC<(N >= 3 || N == Dynamic)> = 0>
	Vector<Real, N> uniformlySampleSimplex(
		const Vector<Real, N>& uv);

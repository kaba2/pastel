...
for i = 1 : matchSize
    ...
    line([S(1, sceneIndex); nM(1, modelIndex)], ...
        [S(2, sceneIndex); nM(2, modelIndex)], 'Color', 'black');
    if modelIndex ~= correctModelIndex
        line([S(1, sceneIndex); nM(1, correctModelIndex)], ...
            [S(2, sceneIndex); nM(2, correctModelIndex)], 'Color', 'red');
    end
end

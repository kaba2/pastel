...
namespace Pastel
{
	...
	namespace Detail_Array
	{
		...
		template <typename Type, int N>
		const Type* ArrayBase<Type, N>::address(const Point<integer, N>& position) const
		{
		...
		template <typename Type, int N>
		Type* ArrayBase<Type, N>::address(const Point<integer, N>& position)
		{

...
namespace Pastel
{
	...
	public:
		...
		PASTEL_CONSTEXPR int Outgoing = Fwd::Outgoing;
		PASTEL_CONSTEXPR int Incoming = Fwd::Incoming;
		PASTEL_CONSTEXPR int Undirected = Fwd::Undirected;
		PASTEL_CONSTEXPR int IncidenceTypes = Fwd::IncidenceTypes;

...
namespace Pastel
{
	...
	*/
	...
	public:
		...
		Vector(const Vector<1, Real>& that)
			: Base(that)
		{
		}
	...
	public:
		...
		Vector(const Vector<2, Real>& that)
			: Base(that)
		{
		}
	...
	public:
		...
		Vector(const Vector<3, Real>& that)
			: Base(that)
		{
		}
	...
	public:
		...
		Vector(const Vector<4, Real>& that)
			: Base(that)
		{
		}
	...
	public:
		...
		*/
		...
		Vector(const Vector<Unbounded, Real>& that)
			: Base(that)
		{
		}
